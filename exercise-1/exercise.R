...
# I see a gray box with nothing in it.
...
ggplot(diamonds.sample) + geom_histogram(mapping = aes(x = depth))
...
ggplot(diamonds.sample) + geom_point(mapping = aes(x = price, y = carat)) + 
